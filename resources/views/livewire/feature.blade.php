<div class="max-w-6xl mx-auto ">
    <div class="flex w-full flex-col mt-6 gap-4">
        <h1 class="text-xl md:text-4xl lg:text-5xl text-brand text-center font-serif">Sharifi High School</h1>
    ...
    <div class="w-full grid grid-cols-3 gap-2" >
        <div class=" w-full col-span-2 rounded-lg shadow-[0px_2px_6px_rgba(0,0,0,0.4)] bg-white">
             <h1 class="text-xl md:text-2xl lg:text-3xl text-brand py-3 px-4 font-serif">About the School</h1>
